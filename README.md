...
### Spoken notifications (Text-to-Speech)

In addition to sound-pack voice lines, peon-ping can **speak** notifications with a TTS engine. Enable it under `tts` in `config.json`:
